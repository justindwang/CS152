...
[0-9]+     {yylval.num = atoi(yytext); colnum += strlen(yytext); return NUMBER;}
[a-zA-Z][_a-zA-Z0-9]*[a-zA-Z0-9] {yylval.id = strdup(yytext);  colnum += strlen(yytext); return IDENT;}
[a-zA-Z]   {yylval.id = strdup(yytext); colnum += 1; return IDENT;}
